...
public class RecloserSnippet extends Dialog {
    ...
    public RecloserSnippet(@NonNull Context context, String sectionID, String DeviceNumber, String EquipmentId, String NetworkId, String deviceType, String voltage, JsonObject jsonObject) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.featuresTv.setText("Recloser");
        ...
        binding.moreBtn.setOnClickListener(view -> {
            ...
            RecloserDialog recloserDialog = new RecloserDialog(mainContext, voltage, jsonObject);
            recloserDialog.show();
        });
    }
