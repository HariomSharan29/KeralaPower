...
public class TransformerSnippet extends Dialog {
    ...
    public TransformerSnippet(@NonNull Context context, String sectionID, String DeviceNumber, String EquipmentId, String NetworkId, String deviceType, String voltage, JsonObject jsonObject) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.featuresTv.setText("Transformer");
        ...
        binding.moreBtn.setOnClickListener(view -> {
            ...
            TransformerDialog transformerDialog = new TransformerDialog(mainContext, NetworkId, voltage, jsonObject,this);
            transformerDialog.show();
        });
    }
