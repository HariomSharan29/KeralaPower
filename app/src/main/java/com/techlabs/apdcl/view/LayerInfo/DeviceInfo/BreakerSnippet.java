...
public class BreakerSnippet extends Dialog {
    ...
    public BreakerSnippet(@NonNull Context context, String sectionID, String DeviceNumber, String EquipmentId, String NetworkId, String deviceType, String voltage, JsonObject jsonObject) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.featuresTv.setText("Breaker");
        ...
        binding.moreBtn.setOnClickListener(view -> {
            ...
            BreakerDialog breakerDialog = new BreakerDialog(mainContext, voltage, jsonObject);
            breakerDialog.show();
        });
