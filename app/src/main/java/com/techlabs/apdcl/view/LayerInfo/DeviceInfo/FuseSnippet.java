...
public class FuseSnippet extends Dialog {
    ...
    public FuseSnippet(@NonNull Context context, String sectionID, String DeviceNumber, String EquipmentId, String NetworkId, String deviceType, String voltage, JsonObject jsonObject) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.featuresTv.setText("Fuse");
        ...
        binding.moreBtn.setOnClickListener(view -> {
            ...
            FuseDialog fuseDialog = new FuseDialog(mainContext, voltage, jsonObject);
            fuseDialog.show();
        });
    }
